//
//  CAPSPageMenu+UIConfiguration.swift
//  StayTuneApp
//
    ...
    func configureUserInterface() {
        ...
        for controller in controllerArray {
            ...
            if configuration.useMenuLikeSegmentedControl {
                ...
                let itemWidthRect: CGRect = (titleText as NSString).boundingRect(with: CGSize(width: 1_000, height: 1_000), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font: configuration.menuItemFont], context: nil)
