...
class YourEventsViewController: UIViewController, YourEventsListView {
    func reloadData() {
        concertsToDisplay = presenter?.getConcerts()
        tableView.reloadData()
    }

    var presenter: YourEventsListPresenter?

    private let cellId: String = "YourEventsCell"
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "YourEventsCell", bundle: nil), forCellReuseIdentifier: cellId)
    ...
    @objc func updateData() {
        ...
        presenter?.loadConcerts(id: userId)
        reloadData()
...
extension YourEventsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellId, for: indexPath) as? YourEventsCell else {
...
extension YourEventsViewController: UITableViewDelegate {
